...
class PriceLoader:
    ...
    def load_data(self, start_date = "2024-09-01",  end_date="2024-09-05") -> list[MarketDataPoint]:
    ...
    # mdd = loader.load_data()
    
    # target_date = pd.Timestamp("2025-09-05")
    # data_on_target = mdd.get(target_date, [])
    # print(data_on_target)
